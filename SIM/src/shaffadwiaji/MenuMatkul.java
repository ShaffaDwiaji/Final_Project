 ...
 * @author Lenovo
 */
public class MenuMatkul extends javax.swing.JFrame {
    Connection con = null;
	ResultSet rs = null;
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        try {
            ...
            pst.setInt(3, Integer.parseInt(jTextField3.getText())); // Assuming jTextField4 is for 'SKS'
            pst.executeUpdate();
            JOptionPane.showMessageDialog(null, "Data mata kuliah berhasil disimpan");
            display();
            clear();
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "Error saat menyimpan data mata kuliah: " + e.getMessage());
        }
    ...
    private void bUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUbahActionPerformed
        try {
            ...
            pst.setInt(2, Integer.parseInt(jTextField3.getText())); // Assuming jTextField4 is for 'SKS'
            ...
            JOptionPane.showMessageDialog(null, "Error saat mengubah data mata kuliah: " + e.getMessage());
        }
    ...
    private void bHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bHapusActionPerformed
        ...
        if (confirm == JOptionPane.YES_OPTION) {
            try {
                ...
                pst.setString(1, jTextField1.getText()); // Assuming jTextField1 is for 'Kode_Matkul'
                pst.executeUpdate();
                JOptionPane.showMessageDialog(null, "Data mata kuliah berhasil dihapus");
                display();
                clear();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error saat menghapus data mata kuliah: " + e.getMessage());
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuMatkul.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuMatkul().setVisible(true);
            }
        });
    }
