...
public class MenuMahasiswa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        rLaki.setForeground(new java.awt.Color(0, 0, 0));
        ...
        rPerem.setBackground(new java.awt.Color(255, 255, 255));
        rPerem.setForeground(new java.awt.Color(0, 0, 0));
        rPerem.setText("Perempuan");
        rPerem.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                rPeremActionPerformed(evt);
            }
        });
    ...
    private void bKuliahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bKuliahActionPerformed
        this.dispose(); // Close current frame
        new MenuPerkuliahan().setVisible(true); // Open MenuPerkulihan frame
    ...
    private void rPeremActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rPeremActionPerformed
        rLaki.setSelected(false);
    }//GEN-LAST:event_rPeremActionPerformed
    ...
    private void bSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSimpanActionPerformed
        try {
            ...
            pst.setString(1, jTextField1.getText()); // Assuming jTextField1 is for 'nim'
            pst.setString(2, jTextField2.getText()); // Assuming jTextField2 is for 'nama'
            pst.setDate(3, java.sql.Date.valueOf(jTextField3.getText())); // Assuming jTextField3 is for 'tgl_lahir'
            pst.setString(4, jTextField4.getText()); // Assuming jTextField4 is for 'alamat'
            pst.setString(5, rLaki.isSelected() ? "Laki-Laki" : "Perempuan"); // Radio button for gender
            pst.executeUpdate();
    ...
    private void bUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bUbahActionPerformed
        try {
            ...
            PreparedStatement pst = con.prepareStatement(sql);
            pst.setString(1, jTextField2.getText()); // Assuming jTextField2 is for 'nama'
            pst.setDate(2, java.sql.Date.valueOf(jTextField3.getText())); // Assuming jTextField3 is for 'tgl_lahir'
            pst.setString(3, jTextField4.getText()); // Assuming jTextField4 is for 'alamat'
            pst.setString(4, rLaki.isSelected() ? "Laki-Laki" : "Perempuan"); // Radio button for gender
            pst.setString(5, jTextField1.getText()); // Assuming jTextField1 is for 'nim'
            pst.executeUpdate();
    ...
    private void tabelBaruMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelBaruMouseClicked
        ...
        jTextField1.setText(tabelBaru.getModel().getValueAt(row, 0).toString()); // Assuming column 0 is 'Nim'
        jTextField2.setText(tabelBaru.getModel().getValueAt(row, 1).toString()); // Assuming column 1 is 'Nama_Mhs'
        jTextField3.setText(tabelBaru.getModel().getValueAt(row, 2).toString()); // Assuming column 2 is 'Tgl_Lahir'
        jTextField4.setText(tabelBaru.getModel().getValueAt(row, 3).toString()); // Assuming column 3 is 'Alamat'
        if ("Laki-Laki".equals(tabelBaru.getModel().getValueAt(row, 4).toString())) {
